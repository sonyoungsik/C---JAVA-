...
public class InputData {
	...
	public int idNumber;
	public int backIdNumber;
	public static int orderCount;
	public static int discount;

void calTicketSelect(){ //권종 선택하기  
...
void calIdNumber(){ //주민등록번호 입력 앞 6글자 구하기 
...
void calBackIdNumber(){ //주민등록번호 입력 뒷 1자리 구하기 
...
void calMaxTicketSelect(){ //티켓 발급 개수 (총10개 제한)
...
void calDiscount(){ //할인 관련 우대사항(5가지)
